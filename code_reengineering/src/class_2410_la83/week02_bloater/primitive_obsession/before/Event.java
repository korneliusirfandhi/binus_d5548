...
public class Event {
    ...
    // primitive obsession
    public String toString(String eventType) {
        if (eventType.equals("Workshop")) {
            return "This event is a workshop.";
        } else if (eventType.equals("Seminar")) {
            return "This event is a seminar.";
        } else if (eventType.equals("Training")) {
            return "This event is a training.";
        }
